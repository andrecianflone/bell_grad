...
# Will try fancy schmancy latex, otherwise fall back to boring font
try:
...
def main_plot(list_of_data, smoothing_window=10,
    ...
    axis_font = {'fontname':font, 'size':'32'}
...
def main():
    ...
    parser.add_argument('--smoothing_window', default=500, type=int)
